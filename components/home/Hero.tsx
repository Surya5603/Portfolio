...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Surya.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-5xl lg:text-6xl tracking-tighter mb-8 font-bold heroShinyBg">
          Passionately Sculpting the digital world by <span className="heroShiny1 text-fun-pink">  building Websites & UI/UX designs.</span> 
          <span className="heroShiny2 text-fun-pink"></span> 
          ...
          {/* <img
            ...
            src="file:///Users/ravi/braydentw.io/public/static/doodles/hero/Suryaa.svg"
          /> */}
          <img
